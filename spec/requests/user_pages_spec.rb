...
describe "User pages" do
  ...
  describe 'signup' do
    ...
    describe 'with valid information' do
      ...
      describe "after saving the user" do
        ...
        it { should have_title(user.name) }
        it { should have_selector('div.alert.alert-success', text: "Let's put a smile on that face") }
      end
    end
  end
  ...
  describe "edit" do
    ...
    describe "page" do
      ...
      it { should have_link('Swap that headshot', href: 'http://gravatar.com/emails') }
    end
